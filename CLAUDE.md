...
Architecture Decision Records in `docs/adr/`. Guides at `docs/adding-a-module.md`, `docs/backend-test-infrastructure.md`, `docs/error-handling.md`, `docs/form-hooks.md`, `docs/mutation-hooks.md`, `docs/query-hooks.md`, `docs/middleware-and-openapi.md`, `docs/soft-delete-cascade.md`, `docs/product-options.md`, `apps/backend/src/core/event-bus/readme.md`.
