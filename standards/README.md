...
### The five kinds a standard can be about
...
resolved twice, and the fix is a line in `pnpm-workspace.yaml`. Which tool enforces what, including
the two kinds this table leaves to Biome and Spectral, is
[below](#which-standards-live-here-and-which-do-not).
