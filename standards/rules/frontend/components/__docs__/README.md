...
| [Button links](./button-links.md) | **Sending the reader to another page from a control that looks like a button.** Use when the thing being clicked changes the URL rather than acting on the page it is on. |
