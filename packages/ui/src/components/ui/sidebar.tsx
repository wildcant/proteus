...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<'ul'>) {
  return (
    <ul
      ...
      className={cn('flex min-w-0 flex-col gap-1 py-0.5 group-data-[collapsible=icon]:hidden', className)}
      {...props}
    />
  )
}
...
function SidebarMenuSubButton({
  ...
  return useRender({
    ...
    props: mergeProps<'a'>(
      {
        className: cn(
          'flex h-7 min-w-0 items-center gap-2 overflow-hidden rounded-md pl-8 pr-2 text-sidebar-foreground/70 ring-sidebar-ring outline-hidden group-data-[collapsible=icon]:hidden hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[size=md]:text-sm data-[size=sm]:text-xs data-active:bg-background data-active:shadow-sm data-active:text-sidebar-accent-foreground [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground',
          className,
        ),
      },
      props,
