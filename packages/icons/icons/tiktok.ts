...
/**
 * @component @name TiktokIcon
 * @description TikTok, rendered as an SVG element.
 *
 ...
 * @source assets/tiktok.svg
 */
export const TiktokIcon = createIcon('Tiktok', iconNode, iconAttributes)
