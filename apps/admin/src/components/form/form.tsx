...
/**
 * Wrapper for every form in the admin that is not a route modal — those use `KeyboundForm`, which
 * owns the same preventDefault plus the ⌘+Enter binding a drawer needs.
 *
