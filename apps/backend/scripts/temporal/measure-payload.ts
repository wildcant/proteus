...
import { createWorkflowActivities } from '../../src/framework/workflows/temporal/activities.js'
import { PROTEUS_WORKFLOW_TYPE, WORKFLOWS_PATH } from '../../src/framework/workflows/temporal/config.js'
import { workflowRegistry } from '../../src/framework/workflows/temporal/registry.js'
import type { DriverInput } from '../../src/framework/workflows/temporal/types.js'
