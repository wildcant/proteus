 ...
 *   `Worker.create` reads the activity map once. The purity rules can parse files because they run
 *   over the repo at verify time; a Worker asking the filesystem what it is running would be
