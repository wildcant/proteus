 ...
 * (see `framework/workflows/temporal/__tests__/temporal-test-env.ts`) because vitest leaves node_modules
 * on plain Node.
 *
 * Shared on purpose, and the reason this file did not follow the queue and driver constants into
 * `framework/workflows/temporal/config.ts`: see `README.md` next door.
 */
