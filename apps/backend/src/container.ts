...
import { bootstrapModule } from './framework/bootstrap/index.js'
import { defineAppConfig } from './framework/config/index.js'
import { resolveEventBusAdapterName } from './framework/event-bus/adapter-selection.js'
import { createInlineEventBus } from './framework/event-bus/inline-adapter.js'
import { subscriberRegistry } from './framework/event-bus/registry.js'
...
import { fulfillmentProviderDeclarations } from './modules/fulfillment/provider-declarations.js'
import inventoryModule from './modules/inventory/index.js'
import notificationModule from './modules/notification/index.js'
import { notificationProviderDeclarations } from './modules/notification/provider-declarations.js'
import orderModule from './modules/order/index.js'
import paymentModule from './modules/payment/index.js'
import { paymentProviderDeclarations } from './modules/payment/provider-declarations.js'
