    ...
    <Drawer open={isOpen} onOpenChange={setOpen} swipeDirection="right">
      ...
      >
        ...
        <div className="flex h-22 shrink-0 items-center justify-between gap-4 px-4 lg:px-6">
          ...
          <DrawerTitle className="type-heading text-ink">
            <Trans>Your Bag</Trans>
          </DrawerTitle>

          <DrawerClose
            render={<Button variant="ghost" size="icon" aria-label={t`Close cart`} className="-mr-2 size-11" />}
          >
          ...
          <>
            ...
            <div className="flex min-h-0 flex-1 flex-col overflow-y-auto px-4 lg:px-6">
              ...
              <p className="m-0 flex shrink-0 items-start gap-2 pb-6 text-ink text-sm">
                ...
                <span>
                  <Trans>
                    <strong className="font-bold">Items in your cart aren't reserved.</strong> Check out soon to make
                  ...
                  <section className="mt-10 pb-6">
                    ...
                    <dl className="m-0 mt-4 flex flex-col gap-3">
                      <div className="flex items-baseline justify-between gap-4">
                        ...
                        <dd className="m-0 text-ink-muted text-sm">
                          <Trans>Calculated at checkout</Trans>
                        </dd>
                      </div>
                      <div className="flex items-baseline justify-between gap-4">
                        <dt className="font-bold text-ink text-sm">
                          <Trans>Total</Trans>
                        </dt>
