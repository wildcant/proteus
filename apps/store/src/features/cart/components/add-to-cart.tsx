  ...
  return (
    <div className="mt-8 space-y-4">
      {product.variants.length > 1 && (
        <div>
          <label htmlFor="variant-select" className="mb-1.5 block font-medium text-foreground text-sm">
            Variant
          </label>
          <NativeSelect
            id="variant-select"
      ...
      <div>
        <label htmlFor="quantity-input" className="mb-1.5 block font-medium text-foreground text-sm">
          Quantity
        </label>
        <NativeSelect
          id="quantity-input"
