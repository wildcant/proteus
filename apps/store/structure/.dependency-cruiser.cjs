...
module.exports = {
  forbidden: [
    ...
    // HTTP stays behind the api layer, shared with the admin. See packages/frontend-structure.
    ...apiLayerRules(),
    ...featureGraphRules,
    {
    ...
    // shared -> features -> app, shared with the admin. See packages/frontend-structure.
    ...layerDirectionRules(),
  ],
